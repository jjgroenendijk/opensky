...
// 19.6): what is currently acting on the player, what the runtime has and has
// not been able to apply, and the two controls that make a potion verifiable
...
// restored health is only convincing next to the health it restored.
//
    ...
    override func makeContentViews() -> [NSView] {
        ...
        return [
            PanelComponents.note(
                "Every effect currently acting on the player, with how much of its duration "
                    + "is left. Consume carried item drinks or eats the first potion or "
                    ...
                    + "moves the health bar and never appears in the list below. The coverage "
                    + "line counts what the runtime declined to do, including every archetype "
