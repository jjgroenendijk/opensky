...
| Readout | `CombatRagdollStatsLabel` | Live and settled counts, bone bodies over joints, solver iterations and violations, admitted pairs and bones touching, pose recoveries |
