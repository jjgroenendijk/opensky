...
| M15.7 combat loop | `World > Combat & Physics > Combat Loop` | `Destination-combatPhysics` | `CombatHostilityControl`, `CombatSpawnDevTargetControl`, `CombatResetDevTargetControl`, `CombatClearTraceControl` | `CombatLoopStatsLabel` | `CombatPhysicsPanelTests`, `CombatLoopStateTests`, `CombatLoopRuntimeTests`, `DevTargetDriverTests`, `CombatHostilitySaveTests`, `DestinationRegistryTests`, `CombatLoopRealDataTests` (env-gated, `make realtest`) | [combat loop](/engine/combat.md) |
...
| M15 overall acceptance | `World > Combat & Physics > Actor Values`, `> Melee`, `> Archery`, `> Death & Ragdoll`, `> Combat Loop`, `> Physics` | `Destination-combatPhysics` | `ActorValueTargetControl`, `ActorValueKindControl`, `ActorValueAmountControl`, `ActorValueDamageControl`, `MeleeWeaponDrawnControl`, `MeleeAttackControl`, `ArcherySpawnControl`, `RagdollTriggerControl`, `CombatHostilityControl`, `CombatSpawnDevTargetControl`, `CombatResetDevTargetControl`, `PhysicsFreezeControl`, `PhysicsResetControl` | `CombatActorValuesStatsLabel`, `CombatMeleeStatsLabel`, `CombatArcheryStatsLabel`, `CombatRagdollStatsLabel`, `CombatLoopStatsLabel`, `CombatPhysicsStatsLabel`, plus the `Destination-combatPhysics-OverrideIndicator` dot | `M15AcceptanceTests`, `M15AcceptancePanelTests`, `M15AcceptanceBudgetTests`, `M15AcceptanceRealDataTests` (env-gated, `make realtest`), `M15AcceptanceRenderTests` (env-gated and device-gated), `CombatPhysicsPanelTests`, `DestinationRegistryTests`, `AppSidebarModelTests` | [combat loop](/engine/combat.md) |
