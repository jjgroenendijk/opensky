...
| M15.4 melee | `World > Player & Locomotion > Melee` | `Destination-playerLocomotion` | `MeleeWeaponDrawnControl`, `MeleeAttackControl`, `MeleeClearTraceControl` | `LocomotionMeleeStatsLabel` | `PlayerLocomotionPanelTests`, `MeleeCombatStateTests`, `MeleeHitDetectionTests`, `MeleeDamageTests`, `MeleeCombatRuntimeTests`, `LocomotionGraphEventFanOutTests`, `DestinationRegistryTests`, `MeleeCombatRealDataTests` (env-gated, `make realtest`) | [melee combat](/engine/melee-combat.md) |
